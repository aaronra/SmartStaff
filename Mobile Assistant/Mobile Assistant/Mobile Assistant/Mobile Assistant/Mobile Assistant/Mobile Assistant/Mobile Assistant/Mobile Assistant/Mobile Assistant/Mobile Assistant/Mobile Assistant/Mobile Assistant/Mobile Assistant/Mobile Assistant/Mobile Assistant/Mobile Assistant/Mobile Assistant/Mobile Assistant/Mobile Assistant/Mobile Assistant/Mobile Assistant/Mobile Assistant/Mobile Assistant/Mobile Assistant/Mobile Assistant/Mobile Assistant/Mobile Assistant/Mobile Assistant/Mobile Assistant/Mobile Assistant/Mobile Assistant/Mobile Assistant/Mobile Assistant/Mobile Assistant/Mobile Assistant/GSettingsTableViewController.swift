...
class GSettingsTableViewController: UITableViewController, UITextFieldDelegate {
    ...
    @IBAction func back(sender: UIBarButtonItem) {
        ...
        var yourEmail = txtYourEmail.text
        var CSUsername = txtCSUsername.text
        var emailAdd = txtEmailAddress.text
        var mobileNum = txtMobileNumber.text
       
    
//     database.printhis(yourEmail, CSUsername: CSUsername, emailAdd: emailAdd, mobileNum: mobileNum)
