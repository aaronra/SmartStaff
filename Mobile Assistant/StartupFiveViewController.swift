//
//  StartupFiveViewController.swift
//  Mobile Assistant
//
...
class StartupFiveViewController: UIViewController {

    @IBOutlet weak var txtCode: UITextField!
    @IBOutlet weak var scrollView: UIScrollView!
    @IBOutlet weak var btnNext: UIButton!
    @IBOutlet weak var btnSkip: UIButton!
    @IBOutlet weak var delegatesMobile: UIScrollView!
    ...
    override func viewDidLoad() {
        ...
        btnSkip.hidden = true
        delegatesMobile.backgroundColor = UIColor(hex: 0x717171)
    }
