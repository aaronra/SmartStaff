//
//  StartupFourViewController.swift
//  Mobile Assistant
//
...
class StartupFourViewController: UIViewController {

    @IBOutlet weak var txtCode: UITextField!
    @IBOutlet weak var scrollView: UIScrollView!
    @IBOutlet weak var btnSkip: UIButton!
    @IBOutlet weak var delegatesEmail: UIScrollView!
    ...
    override func viewDidLoad() {
        ...
        delegatesEmail.backgroundColor = UIColor(hex: 0x717171)
    }
    ...
    @IBAction func Next(sender: UIButton) {
        self.performSegueWithIdentifier("toStartupFive", sender: self)
    }
