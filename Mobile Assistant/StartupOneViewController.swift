//
//  StartupOneViewController.swift
//  Mobile Assistant
//
...
class StartupOneViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        welcome.backgroundColor = UIColor(hex: 0x717171)
    }
    ...
    @IBAction func Skip(sender: UIButton) {
        self.performSegueWithIdentifier("toStartupTwo", sender: self)
    }
