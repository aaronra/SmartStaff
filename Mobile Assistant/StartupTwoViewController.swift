//
//  StartupTwoViewController.swift
//  Mobile Assistant
//
...
class StartupTwoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        scrollView.backgroundColor = UIColor(hex: 0x717171)
    }
    ...
    func keyboardWasShown(notification: NSNotification) {
        ...
        var buttonOrigin: CGPoint = self.btnNext.frame.origin;
        var buttonHeight: CGFloat = self.btnNext.frame.size.height;
    ...
    @IBAction func Next(sender: UIButton) {
        self.performSegueWithIdentifier("toStartupThree", sender: self)
    }
